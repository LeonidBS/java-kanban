...
class InMemoryHistoryManagerTest {
    public static final InMemoryHistoryManager inMemoryHistoryManager = new InMemoryHistoryManager();
    public static final InMemoryTaskManager inMemoryTaskManager = new InMemoryTaskManager();
    public Task task = new Task("New Task for HistoryManager testing",
            "details for Task for HistoryManager testing",
            LocalDateTime.parse("2023-02-21T08:00"),1800);

    @Test
    void addInEmptyListTest() {
